...
hi DiffFile        guifg=#ffffff               gui=bold
hi DiffOldFile     guifg=#FF0000               gui=bold
hi DiffNewFile     guifg=#A6E22E               gui=bold
hi DiffLine        guifg=#FD971F               gui=bold
hi DiffRemoved     guifg=#FF0000
hi DiffAdded       guifg=#A6E22E
...
if &t_Co > 255
   ...
   hi DiffFile        ctermfg=255             cterm=bold
   hi DiffOldFile     ctermfg=1               cterm=bold
   hi DiffNewFile     ctermfg=2               cterm=bold
   hi DiffLine        ctermfg=208             cterm=bold
